...
function Films() {
  ...
  const [urlFilm, setUrlFilm] = useState(urlAllPath.films);
  return (
      ...
      <div className="max-w-7xl mx-auto">
        ...
        <div className="flex items-center mb-12">
          <div className="relative flex items-center w-full max-w-xl">
            ...
            />
            <a href={urlFilm} className="absolute right-0 top-0 bottom-0 bg-gray-300 hover:bg-gray-400 text-gray-900 font-bold py-4 px-6 rounded-r-lg transition duration-300 ease-in-out">
              <svg
                className="h-6 w-6"
                fill="none"
                viewBox="0 0 24 24"
        ...
        <div className="bg-gray-100 rounded-lg shadow-md p-6">
          ...
          <div className="flex items-center justify-between bg-gray-200 rounded-lg p-4">
            <code className="text-gray-900 text-lg">
              curl "https://swapi.info/api/films"
            </code>
